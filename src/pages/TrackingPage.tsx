...
export function TrackingPage() {
  ...
  }, [purchases, returns, transfers, activeTab, searchTerm, productSearchTerm, statusFilter, showArchived]);
  ...
  return (
    <DashboardLayout>
      ...
      <CreatePurchaseDialog open={createPurchaseOpen} onOpenChange={setCreatePurchaseOpen} onPurchaseCreated={fetchPurchases} />
