-- ============================================================================
-- CONFIGURAR CRON JOBS - Sistema Multi-Tenant
-- ============================================================================
...
-- ✅ 2 cron jobs criados
-- ✅ baselinker-event-poller roda a cada 1 minuto
-- ✅ send-scheduled-messages roda diariamente às 9h
-- ✅ Sistema processa TODOS os workspaces automaticamente
-- ✅ Cada workspace usa suas próprias credenciais
